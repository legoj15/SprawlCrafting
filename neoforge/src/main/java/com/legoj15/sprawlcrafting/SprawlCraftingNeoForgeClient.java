...
public class SprawlCraftingNeoForgeClient {

    public SprawlCraftingNeoForgeClient(IEventBus modEventBus) {
        NeoForge.EVENT_BUS.addListener(SprawlCraftingNeoForgeClient::onLoggingOut);
    }
